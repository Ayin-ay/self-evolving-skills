...
拿不准的地方会改变人物评价、全文结论或读者行动时，正文交代一次。其余疑点删掉或放进来源说明。
...
稿件需要提及某个外部文档（README 章节、安装说明、仓库文件、链接内容）时，先核对该内容当前真实存在且表述一致，再写进稿件。禁止凭记忆或凭计划中的状态描述外部材料。宣传稿、教程稿交稿前，把稿件里所有指向外部文档的表述逐条与实物比对一遍，不一致的改正或删掉。
